...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 30 nov. 2023 à 00:49
...
(11, 'Pokémon Sword', '2019-11-15', 'Devenez un Dresseur Pokémon et explorez la région de Galar en quête de gloire et de nouveaux Pokémon. Affrontez des rivaux, découvrez des créatures légendaires, et devenez le champion de l\'arène dans cette aventure captivante.', 'Game Freak', 'Nintendo', 'Pokemon_Sword.jpg', NULL),
...
(16, 'Celeste', '2018-01-25', 'Un jeu de plateforme difficile avec une histoire touchante.', 'Maddy Makes Games', 'Maddy Makes Games', 'Celeste.jpg', NULL),
(18, 'Doom Eternal', '2020-03-20', 'Combattez des hordes démoniaques dans ce FPS intense.', 'id Software', 'Bethesda Softworks', 'Doom_Eternal.jpg', NULL),
(19, 'Stardew Valley', '2016-02-26', 'Échappez à la vie citadine pour gérer votre propre ferme.', 'ConcernedApe', 'ConcernedApe', 'Stardew_Valley.png', NULL),
(20, 'Civilization VI', '2016-10-21', 'Construisez votre civilisation à travers l\'histoire dans ce jeu de stratégie.', 'Firaxis Games', '2K Games', 'Civilization_VI.jpg', NULL),
(21, 'Overwatch', '2016-05-24', 'Un jeu de tir multijoueur en équipe avec des héros uniques.', 'Blizzard Entertainment', 'Blizzard Entertainment', 'Overwatch.jpeg', NULL),
(22, 'The Sims 4', '2014-09-02', 'Simulez la vie de vos personnages dans ce jeu de simulation de vie.', 'Maxis', 'Electronic Arts', 'The_Sims_4.jpeg', NULL),
(23, 'Super Mario Odyssey', '2017-10-27', 'Mario part en voyage pour sauver la princesse Peach.', 'Nintendo', 'Nintendo', 'Super_Mario_Odyssey.jpeg', NULL),
(24, 'Halo: Master Chief Collection', '2014-11-11', 'Une collection de jeux de la série Halo pour Xbox.', '343 Industries', 'Xbox Game Studios', 'Halo_The_Master_Chief_Collection.jpg', NULL),
(25, 'Horizon Zero Dawn', '2017-02-28', 'Un monde ouvert post-apocalyptique où des machines règnent.', 'Guerrilla Games', 'Sony Interactive Entertainment', 'Horizon_Zero_Dawn.jpeg', NULL),
(26, 'Monster Hunter: World', '2018-01-26', 'Chassez des monstres énormes dans ce jeu de rôle daction.', 'Capcom', 'Capcom', 'Monster_Hunter_World.jpg', NULL),
(27, 'The Elder Scrolls V: Skyrim', '2011-11-11', 'Explorez un vaste monde ouvert rempli de dragons et de mystères.', 'Bethesda Game Studios', 'Bethesda Softworks', 'The_Elder_Scroll_V_Skyrim.jpg', NULL),
(28, 'Star Wars Jedi: Fallen Order', '2019-11-15', 'Vivez une histoire Star Wars en tant que jeune Jedi fugitif.', 'Respawn Entertainment', 'Electronic Arts', 'Star_Wars_Jedi_Fallen_Order.jpg', NULL),
(29, 'Pokémon Shield', '2019-11-15', 'Devenez un Dresseur Pokémon et explorez la région de Galar en quête de gloire et de nouveaux Pokémon. Affrontez des rivaux, découvrez des créatures légendaires, et devenez le champion de l\\\'arène dans cette aventure captivante.', 'Game Freak', 'Nintendo', 'Pokemon_Shield.jpg', NULL),
(17, 'Nom du jeu', '2023-11-22', 'Description', 'Développeur', 'Éditeur', 'Image', 'Vidéo'),
(15, 'Nom du jeu', '2023-11-22', 'Description', 'Développeur', 'Éditeur', 'Image', 'Vidéo');
...
CREATE TABLE IF NOT EXISTS `notes` (
  ...
  KEY `id_jeu` (`id_jeu`)
) ENGINE=MyISAM AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_520_ci;
